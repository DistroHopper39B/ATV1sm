  ...
  )
{
  ...
  //
  DestinationPages = AllocateAlignedPages (
             DestinationPages,
  ...
  )
{
  ...
  if (SetJumpFlag == 0) {
    ...
    //
    gBS->Exit (OcLoadedImage, ImageHandle, OcLoadedImage->Status, 0, NULL);
  }
  ...
  )
{
  ...
  Status = OcImageLoaderLoad(BootPolicy,
                             ParentImageHandle,
                             DevicePath,
                             SourceBuffer,
                             SourceSize,
