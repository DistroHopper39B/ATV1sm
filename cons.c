...
boolean_t cons_init(void *video_params, uint32_t fg_color, uint32_t bg_color)
{
    ...
    Status = gBS->LocateProtocol(&AppleScreenInfoGuid, NULL, (VOID **) &AppleScreenInfo);
    ...
    Status = AppleScreenInfo->GetInfo(AppleScreenInfo, &fb.base,
                                      &fb.size,
                                      &fb.pitch,
                                      &fb.width,
                                      &fb.height,
