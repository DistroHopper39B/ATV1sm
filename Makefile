...
CFLAGS := -Wall -Werror -fno-stack-protector -nostdlib -fno-builtin -O0 -std=gnu11 --target=$(TARGET) -Iinclude -Ignu-efi/inc -fshort-wchar -mno-red-zone -isysroot $(SDK)
...
OBJS_OPENCORE_LIB := ImageLoader.o fileload.o OpenFile.o
