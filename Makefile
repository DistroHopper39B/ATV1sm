...
OBJS_UDK_LIB :=
OBJS := main.o baselibc_string.o cons.o tinyprintf.o memory.o runtime_override.o pecoff.o $(addprefix gnu-efi/lib/, $(OBJS_GNUEFI_LIB)) #$(addprefix opencore/, $(OBJS_OPENCORE_LIB))
